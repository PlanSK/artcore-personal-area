# Generated by Django 4.1 on 2023-04-06 18:09
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.DateTimeField(blank=True, null=True, verbose_name='Время прибытия кассира'),
        ),
        migrations.AddField(
            model_name='workingshift',
            name='hall_admin_arrival_time',
            field=models.DateTimeField(blank=True, null=True, verbose_name='Время прибытия админа'),
        ),
        migrations.AddField(
            model_name='workingshift',
            name='next_cashier',
        ...
        migrations.AlterField(
            model_name='workingshift',
            name='status',
            field=models.CharField(choices=[('NOT_CONFIRMED', 'Не подтверждена'), ('UVD', 'Не проверена'), ('WTC', 'Ожидает исправления'), ('VFD', 'Проверена')], db_column='shift_status', default='UVD', max_length=20, verbose_name='Статус смены'),
        ),
