# Generated by Django 4.1 on 2023-03-05 13:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('additional_services_revenue', models.FloatField(default=0.0, verbose_name='Выручка доп. услуги')),
                ...
                ('slug', models.SlugField(blank=True, max_length=60, null=True, unique=True, verbose_name='URL')),
                ('status', models.CharField(choices=[('UVD', 'Не проверена'), ('WTC', 'Ожидает исправления'), ('VFD', 'Проверена')], db_column='shift_status', default='UVD', max_length=20, verbose_name='Статус смены')),
