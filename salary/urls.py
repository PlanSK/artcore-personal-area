...
urlpatterns = [
    ...
    path('workshifts_for_year/<int:year>/', StaffWorkshiftsForYear.as_view(), name='workshifts_for_year'),
    path('workshifts_all_years/', StaffWorkshiftsYearList.as_view(), name='workshifts_all_years'),
